...
const introData = {
  ...
  name: 'Alex Developer',
  role: '全栈开发工程师',
  bio: '热爱开源，专注于 Vue 生态系统与高性能 Web 应用开发。目前正在折腾 VitePress 和独立开发产品。',
  tags: ['Vue 3', 'TypeScript', 'VitePress', 'Node.js', 'Tailwind CSS'],
  socials: [
    {
      link: 'https://github.com',
      label: 'GitHub',
      // 这里是 GitHub 的 SVG 图标代码
